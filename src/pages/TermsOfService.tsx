...
export default function TermsOfService() {
  ...
  if (config.termsPublished === false) {
    return (
  ...
  const hasContent = Boolean(config.termsContent && config.termsContent.trim());

  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900 font-sans flex flex-col justify-between">
      <SEOHead
        title={`Terms of Service – ${config.siteName}`}
        description={`Terms of Service and usage agreement for ${config.siteName}.`}
            ...
            {hasContent ? (
              ...
              <div className="text-center py-16 px-4 bg-neutral-50 rounded-2xl border border-neutral-100">
                ...
                <p className="text-sm text-neutral-500 max-w-md mx-auto">
                  The Terms of Service for this website have not been published by the administrator yet.
                </p>
              </div>
            )}
          </div>
