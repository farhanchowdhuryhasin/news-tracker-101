...
export default function AboutUs() {
  ...
  if (config.aboutPublished === false) {
    return (
  ...
  const hasContent = Boolean(config.aboutContent && config.aboutContent.trim());
            ...
            {hasContent ? (
              ...
              <div className="text-center py-16 px-4 bg-neutral-50 rounded-2xl border border-neutral-100">
                ...
                <p className="text-sm text-neutral-500 max-w-md mx-auto">
                  About information for this website has not been published by the administrator yet.
                </p>
              </div>
            )}
          </div>
