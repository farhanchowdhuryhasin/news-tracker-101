...
export default function Disclaimer() {
  ...
  if (config.disclaimerPublished === false) {
    return (
  ...
  const hasContent = Boolean(config.disclaimerContent && config.disclaimerContent.trim());

  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900 font-sans flex flex-col justify-between">
      <SEOHead
        title={`Disclaimer – ${config.siteName}`}
        description={`Legal disclaimer and notices for ${config.siteName}.`}
            ...
            {hasContent ? (
              ...
              <div className="text-center py-16 px-4 bg-neutral-50 rounded-2xl border border-neutral-100">
                ...
                <p className="text-sm text-neutral-500 max-w-md mx-auto">
                  The Disclaimer for this website has not been published by the administrator yet.
                </p>
              </div>
            )}
          </div>
